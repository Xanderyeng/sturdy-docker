...
execSync( `docker-compose -f ${getComposeFile} exec server make docker-restore`, { stdio: 'inherit' } );
...
execSync( `docker-compose -f ${getComposeFile} exec server make docker-services`, { stdio: 'inherit' } );
